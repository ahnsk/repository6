...
<%}else if(menu.equals("search")) {%>
	...
	<tr class="ct_list_pop">
		...
		<td align="left" value="prodName"><a href="/updateProductView.do?prodNo=${i.prodNo }" >${i.prodName}</a></td>			
		</c:if>
			<c:if test="${param.menu =='search' }">
			
			<td align="left"><a href="/getProduct.do?prodNo=${ i.prodNo }">${ i.prodName }</a></td>
			</c:if>
		<td></td>
